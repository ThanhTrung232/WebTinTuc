    ...
    <script src="<?php echo URLROOT;?>/public/admin/datatables/dataTables.bootstrap4.js"></script>

    <!-- Demo scripts for this page-->
    <script src="<?php echo URLROOT;?>/public/admin/js/demo/datatables-demo.js"></script>
